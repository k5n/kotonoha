export const en = {
  translation: {
    ...
    episodeDetailPage: {
      ...
      subtitleLineDeleted: 'Subtitle line deleted.',
      deleteConfirm: {
        title: 'Delete Subtitle Line',
        message: 'Are you sure you want to delete this subtitle line? This action can be undone.',
      },
      errors: {
        analyzeFailed: 'An error occurred while analyzing the subtitle line.',
        createCardsFailed: 'An error occurred while creating cards.',
        updateSubtitleLineFailed: 'Failed to update subtitle line.',
        deleteSubtitleLineFailed: 'Failed to delete subtitle line.',
        undoDeleteSubtitleLineFailed: 'Failed to undo subtitle line deletion.',
    ...
    components: {
      ...
      ttsExecutionModal: {
        ...
        pleaseWait: 'Please wait while the audio is being generated...',
        completed: 'Audio generation completed successfully.',
        close: 'Close',
        error: {
