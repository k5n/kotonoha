...
describe('parseScriptToSubtitleLines', () => {
  ...
  it('calls parseSrtToSubtitleLines for srt extension', () => {
  ...
  it('calls parseSswtToSubtitleLines for sswt extension', () => {
  ...
  it('calls parseTsvToSubtitleLines for tsv extension with config', () => {
  ...
  it('calls parseVttToSubtitleLines for vtt extension', () => {
