...
- [ ] 1. エピソードソース選択モーダルの実装 (P)
- [ ] 1.1 (P) 基本的なソース選択UIコンポーネントの作成
...
- [ ] 2. ファイルエピソード追加モーダルの実装 (P)
- [ ] 2.1 (P) ファイル専用追加ダイアログの作成
...
- [ ] 4. エピソードリストページでの統合モーダル制御システムの実装
- [ ] 4.1 モーダル状態管理コントローラーの作成
...
- [ ] 6.2 YouTubeエピソード追加モーダルの統合テスト作成
