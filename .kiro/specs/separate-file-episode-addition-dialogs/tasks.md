...
- [x] 1. EpisodeSourceSelectionModalにファイル詳細選択機能を追加
- [x] 1.1 (P) ファイル追加方法選択UIの実装
...
- [x] 6. API契約とデータ互換性の確保
- [x] 6.1 addNewEpisodeユースケースとの互換性検証
...
- [x] 6.2 (P) データベーススキーマとファイル保存形式の維持確認
...
- [x] 7.\* 既存テストケースの更新と新規テスト追加
- [x] 7.1\* episode-list.file.browser.test.tsの更新
